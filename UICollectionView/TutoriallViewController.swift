...
class TutoriallViewController: UIViewController{
    ...
    private func setupCollection() {
        ...
        if let flowLayout = myCollectionView.collectionViewLayout as? UICollectionViewFlowLayout {
            flowLayout.minimumLineSpacing  = 0 // khoảng cách các dòng
...
extension TutoriallViewController: UICollectionViewDataSource {
    /**
     mặc định sẽ là 1
...
extension TutoriallViewController: UICollectionViewDelegate {
